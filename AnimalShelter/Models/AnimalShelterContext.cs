    ...
    public class AnimalShelterContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            builder.Entity<Animal>()
                .HasData(
                    new Animal { AnimalId = 1, Name = "Fifi", Species = "Mutt", Age = 1, Gender = "Female" },
                    ...
                    new Animal { AnimalId = 5, Name = "Gus", Species = "Bunny", Age = 2, Gender = "Male" }
                    new Animal { AnimalId = 6, Name = "Commando", Species = "Mutt", Age = 3, Gender = "Female" },
                    ...
                    new Animal { AnimalId = 11, Name = "Muffin", Species = "Mutt", Age = 3, Gender = "Female" },
                    new Animal { AnimalId = 12, Name = "Dumbo", Species = "Lizard", Age = 1, Gender = "Unknown" },
                    ...
                    new Animal { AnimalId = 16, Name = "Peggy", Species = "Mutt", Age = 3, Gender = "Female" },
                    new Animal { AnimalId = 17, Name = "Herb", Species = "Lizard", Age = 1, Gender = "Unknown" },
